...
<?php
	...
	if ($result->num_rows > 0) 
	{
		...
		{
			    echo "<tr> <td>" . $row["ride_id"]. " </td> <td> " . $row["source"]. "</td> <td> " . $row["destination"]."</td> <td> " . $row["date_time"]. " </td> <td> ". $row["car_rc_detail"]."</td></tr>";
		}
		?>
		</tbody>
		</table>
	...
	$conn->close();
?>
<button onclick='document.getElementById("newride").style.display = "block"'>Add new ride  </button>
</center>
...
<div class="centered-div" id=newride style="display:none" >
	<div class="centered-div-content">
		<h1 align="center">Share Your Cab</h1>
